...
\label{Chapter8}
\lhead{Chapter VIII. \emph{Results and Expert Validation}}
...
It is worth being precise about what the validation conducted for this thesis did and did not establish. The evaluation that took place at ITC headquarters in Bangalore was an expert demonstration: ITC food analysts and quality managers observed the high-fidelity prototype operating on real wheat samples and provided structured qualitative feedback. What it was not, and cannot be until multi-site field trials are completed, is a definitive performance benchmark. The distinction matters. The Bangalore evaluation could assess whether the device behaved as intended and whether experienced evaluators judged its outputs to be plausible; it could not establish statistical confidence bounds on classification accuracy across the full range of seasonal and regional variation that characterises ITC's actual procurement conditions.
...
On the digital interface, threshold visualisation was rated more immediately interpretable than the numerical tabular format used in existing ITC assessment records. The distinction appeared most pronounced among senior managers, who described the threshold-relative indicators as making borderline cases more visible rather than requiring mental comparison of a number against a remembered limit. The Admin Review feature for $\pm 2\%$ threshold samples received explicit approval from senior quality managers, who framed it as consistent with how they already exercise oversight in manual assessment---reviewing borderline calls personally rather than delegating the finalisation of ambiguous results.
