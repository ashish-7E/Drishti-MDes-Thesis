...
{\bigskip
    \HRule \\[0.1cm] 
		...
		\HRule \\[0.1cm] 	
This thesis documents the design and development of the \textbf{``Drishti'' Wheat Grain Analyser}, an automated device for wheat grain quality assessment at FMCG procurement warehouses. Manual assessment of a 100-gram wheat sample --- approximately 2,800 grain entities across twelve categories --- takes up to sixty minutes per cycle. This creates logistical bottlenecks and introduces inconsistency due to operator fatigue and uneven expertise.
