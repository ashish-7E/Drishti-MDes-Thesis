% Appendix A — ITC Grain Classification Thresholds

\chapter{ITC Wheat Quality Thresholds and Classification Categories}

\label{AppendixA}

\lhead{Appendix A. \emph{Grain Classification Thresholds}}

This appendix documents the twelve grain and impurity categories central to ITC Limited's procurement quality assessment protocol, and the corresponding $W/W\%$ thresholds against which each sample is evaluated. These thresholds were provided by ITC food analysts during the contextual inquiry phase and form the benchmark against which the Drishti classifier is calibrated.

\vspace{1em}

\begin{table}[h!]
\centering
\caption{Wheat grain classification categories and indicative $W/W\%$ thresholds as applied in ITC's procurement protocol. Specific threshold values are proprietary and represented here in generalised form.}
